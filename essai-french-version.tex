...
Il faut dire que les musiciens sortent difficilement du cadre tonal ou de leur piédestal elitiste, de leurs habitudes plus ou moins professionnelles, tandis que les autres se déclarent ineptes à toutes pratiques musicales. En bref, les uns produisent, les autres consomment, point. 
...
et par extension à répertorier ces objets pour une culture donnée, de leur singularité à leur taxonomie à l'échelle de l'humanité.}, les différentes tendances musicales de ce \textsc{xx}\ieme ~siècle.
 ...
 dont la manipulation compositionnelle s'effectue de manière intuitive, scripturale, analogique, ou numérique\sidenote{Grâce notamment au sérialisme integral -- qui a ouvert une brèche sur l’aspect compositionnel concernant l’ensemble des paramètres contrôlables qui caractérisent l'objet sonore. La source sonore s'inscrit alors -- en plus de la hauteur et de la dynamique -- dans un mode de production et de contextualisation, tel que le traitement du signal, physique, analogique ou numérique, et l’acoustique en termes de spatialisation et de psychoacoustique.}. 
...
Tout cela s'est construit, si l'on peut dire, sur la déconstruction\sidenote{Autant certains artistes radicaux du début du XX\up{e} siècle pressentaient les dérives tyranniques de l'ère industriel, autant beaucoup d'artistes du second après-guerre, notamment durant les années 60 et 70, 
...
qui s'est traduit dans un premier temps par deux courants antagonistes remettant en cause les conventions et les contraintes idéologiques, esthétiques et politiques de leur époque, que furent les futuristes %\footnote{} 
...
Retenons que ces mouvements étaient fortement politisés et provocateurs, flirtant avec le fascisme pour les uns, et l'anarchie pour les autres, voire le communisme pour le reste. %, ils étaient tous révolutionnaires. 
...
La forme est alors de type mobile, tant que les moments ne sont pas reliés entre eux ou peuvent l'être suivant une esthétique compositonelle prédéfinit et bien entendu de façon non hiérarchique, et intègre de la sorte un potentiel de \textit{« never-ending process »}.
...
}, son placement en temps, et le contexte environnemental. Il serait par trop dissert d'en décrire tous les aspects, mais il est possible d'en distinguer au moins trois classes. Le silence de prolongation, celui qui fait résonance avec, et résonner, l'espace en termes de réverbération, comme la queue d'une comète représentant le (ou les) son(s) qui précéde(nt) cet état, et qui persiste(nt) dans notre esprit au delà de son effectivité dans l'espace partagé avec l'auditeur. % de son(leur) existence. 
...
Bien sûr, pour satisfaire une certaine démocratisation, il y eut une volonté pragmatique de standardiser la notation musicale -- encore en vigueur dans l'enseignement musicale --, notamment initié en Europe avec l'imprimerie et la typographie durant la renaissance jusqu'au romantisme. Cependant, essentiellement destinées aux musiques modales et tonales, seuls quelques paramètres musicaux étaient considérés, tels que la hauteur, la durée, puis la dynamique, le tempo, le caractère, les accents, etc. évoluant sans cesse, élargissant un répertoire de signes convenus selon l'esthétique musicale du moment.  
...
\bigskip
 ...
 Le changement de paradigme se fait dans la manière de vivre la musique\sidenote{À l'encontre du paradigme civilisationnel et mondialiste qui consiste à la division et à la « compartimentation » du travail impliquant pour ce qui concerne la musique, le compositeur maître imposant sa volonté à l’interprète, et l’interprété esclave, soumis, qui veut tirer parti de la composition pour se mettre en valeur; hiérarchisation extrême avec le dieu compositeur, le chef d’orchestre meneur de troupe, et d’obéissant soldats musiciens pour un résultat, certes parfois spectaculaire, mais fanatisant, hégémonique, voire suprémaciste;  et de réduire l'acte artistique à une seule personne pour légitimer une hiérarchie omniprésente, dévalorisant toute activité subalterne, laquelle se réduit à des exécutants que l'on appelle professionnels pour verrouiller le système. Et enfin le public qui dicte ses volontés sans toutefois intervenir directement dans l’œuvre. 
...
Dans le meilleur des cas, quelques traces de ces pratiques subsistent, cantonnées au cadre pédagogique d’éveil ou de sensibilisation musical, en marge de l'enseignement traditionnel (basé sur le solfège tonal), ou bien être anecdotiquement mentionnées sur les ouvrages spécialisés de l’histoire de la musique.
...
en conscience, comme le fît  Monsieur Jourdan en découvrant qu'il faisait de la prose sans le savoir\sidenote{Référence à la comédie-ballet de Molière \textit{Le Bourgeois gentilhomme} (1670). À l'acte II scène IV,  Monsieur Jourdan apprend lors d'un échange avec le maître de philosophie, que \textit{\hbox{\normalfont{«} tout} ce qui n'est point prose est vers; et tout ce qui n'est point vers est \hbox{prose \normalfont{»}}};  et Monsieur Jourdan de répondre plus loin: \textit{\hbox{\normalfont{«} Par} ma foi ! il y a plus de quarante ans que je dis de la prose sans que j’en susse rien, et je vous suis le plus obligé du monde de m’avoir appris \hbox{cela. \normalfont{»}}}}.
