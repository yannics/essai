...
Penser la musique autrement, c'est prendre conscience que tout peut être musique\sidenote{En effet, tout phénomène se déployant en temps et pouvant être analyser ou modéliser de manière discrete, analogique, ou symbolique, peut être converti par transposition ou substitution en une caractéristique, une donnée, entrant dans le champ de l’audible. Dans ce cas de figure, il est possible d’ouïr le « chant » des fourmis, d’avoir une image sonore du fond diffus cosmologique, d’interagir dynamiquement avec un flux de données  Wi-Fi. 
