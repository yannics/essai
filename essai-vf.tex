...
La forme est alors de type mobile, tant que les moments ne sont pas reliés entre eux ou peuvent l'être suivant une esthétique compositonelle prédéfinie et bien entendu de façon non hiérarchique, et intègre de la sorte un potentiel de \textit{« never-ending process »}.
...
Cependant, rien n'empêche d'inclure ces modalités comme directive(s) par \linebreak l'exemple, par ce qui doit être fait, ou sur ce qu'il est possible de faire.
