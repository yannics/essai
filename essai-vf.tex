...
\color{red}{D'ailleurs, la section \textsl{Le phénomène emergent} et la note 64 sont en cours de réécriture.}
\color{black}
\bigskip
...
Certes on peut acquérir cette confiance par un « forcing » requérant des répétitions rébarbatives et un entrainement plus ou moins intensif, mais en cela on force la nature -- à moins qu’il ne s’agisse de la nature même de la personne en question, et que l'on considère la vie comme une lutte permanente, une conquête du plus fort, du plus performant, une compétition favorisant les favorisés, véritable \textit{credo} de notre civilisation, et entériner par le darwinisme primaire\sidenote{Au sens « doxique » du terme qui entretient une confusion certaine entre les théories évolutionnistes exposées par Jean-Baptiste de Lamarck en 1809 dans \textit{Philosophie zoologique}, puis par Charles Darwin en 1859 dans \textit{L'Origine des espèces (On the Origin of Species)}, dont l'idée première relate d'une sélection naturelle et graduelle induite par l'environnement pour l'un (en termes de complexité), et d'une concurrence dite vitale pour l'autre (notamment en termes de variations héréditaires dites << spontanées ou accidentelles >>). %dans le processus de l'évolution des espèces. 
Ce qui peut en constituer une possible cause -- quoique le terme d'évolution me parait plutôt excessif (bien que Darwin parle plus volontiers de perfectionnement, ce qui ne change rien à l'affaire) quant il s'agit seulement d'une adaptation, d'un développement, voire même d'une recherche spontanée d'optimisation de l'entité dans son milieu. % -- bien qu'il existe des organismes qui se reproduisent mécaniquement sans dessein (\textit{i.e.} gène égoïste) ou qui ne possèdent pas de lien généalogique (\textit{i.e.} gène orphelin). 
Et évoluer vers quoi? Si l'on considère la complexité organique comme une évolution (vers l'émergence de la conscience par exemple), certes, l'espèce humaine pourrait en être l'aboutissement (provisoire) de l'évolution, ce qui implique un dessein téléologique, plus idéologique et anthropo-centré que scientifique et objectif, car nous partageons cette complexité organique pour le moins avec la plupart des mammifères (dont certains sont manifestement dotés d'une réelle forme de conscience). De plus, il existe des théories dont la pertinence est avérée, telles que par exemple l'idée ou le concept de niche, qui induit la notion d'harmonie (et non de concurrence) avec l'environnement selon les limites et les capacités du sujet en tant qu'entité biologique, ce qui semble plus « conforme » à la réalité, notamment archéologique (\textit{i.e.} la discontinuité du registre fossile). En tout état de cause, ces différentes approches, qu'elles soient liées à l'évolution lamarckienne, darwinienne, ou aux principes de niches écologiques, ne sont en aucun cas exclusives. Bref, c'est un sujet complexe, dont la confusion sert sans aucun doute les intérêts des possédants sous l'égide d'un impérieux empire globaliste.}. Alors qu'il suffit de se focaliser autour d’un but commun, pour que la confiance s'établisse, que notre perfectionnement, notre développement, tant en pratique que spirituel, aillent de soi, portés par la dynamique bienveillante du groupe, ce qui peut aussi être vrai dans les relations inter-groupes.
