...
Seulement, une certaine disparité `notationnelle' concernant certain paramètre (concernant les sonorités `exotiques' par exemple) tendait depuis lors (notamment à partir du début du  \textsc{xx}\ieme ~siècle) vers une  spécialisation par type, par compositeur, voire par œuvre.
