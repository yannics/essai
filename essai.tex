...
Déjà évoqué en tant que possible `cluster polysémique nodal fluctuant'\footref{efn:concept}, le concept -- du latin \textit{conceptus} qui renvoie à l'action de contenir -- est la representation de l'esprit par un signifiant, articulé notamment par inférence dans une chaine de signifiants, d'un signifié `gestaltique'\footref{efn:gestalt}, appliqué -- par extension à notre propre perception, et par abstraction -- à notre propre compréhension du monde. 
...
%    
  ...
  ... musiques imaginaires ou imaginées -- $\rightarrow$  musique en creux
  
  ... \textit{soundscape}
  
  ... musiques algorithmiques (process -- fractalité)
