...
Ces mouvements se sont revendiqués comme un art de vivre, et de nombreux émules ont prolongés l'idée artistique première et l'ont pour certain réactualisés dans la seconde moitié de ce \textsc{xx}\ieme ~siècle, en tant que mouvement autonome tel que Fluxus par exemple -- précédé par le surréalisme\endnote{Entre poésie et arts plastiques, la musique surréaliste se définit plus comme une insurrection dadaïste, une totale liberté, qu'une exploration, une expression, de l'inconscient ou onirique.} de l'entre deux guerres -- ou en tant que démarche artistique avec notamment la musique concrète. Cent ans après, l'héritage musicale futuriste est omniprésent chez la plupart des compositeurs, bien que certains se revendiquent volontiers du dadaïsme dans l'esprit, l'un n'empêchant pas l'autre. 
