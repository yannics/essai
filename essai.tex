...
L'articulation se définit alors en termes d'accentuation, de ponctuation, de transition, et de caractère.
...
Il va sans dire que tous ces points ne sont pas exclusif, et au contraire sont corrélés entre eux.
 \end{enumerate}
Les deux points suivants s’inscrivent dans un rapport inter-relationnel d’ordre supérieur impliquant au moins deux objets sonores en temps.
...
Étroitement lié au caractère,  emprunt d'un concept linguistiques, la ponctuation en musique concerne l'articulation prosodique en termes de respiration, d'intonation, et de cadence. Cela s'applique au niveau du motif ou de la phrase au sein d'une section.
